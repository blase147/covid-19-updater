...
# Live-Demo
> Here is a link (https://blase147.github.io/react-captone-hub/) to the live page.
...
## Steps
- To clone the project select the desired directory in cmd and run: `git clone https://github.com/blase147/react-capstone-hub.git`
...
```bash
git clone https://github.com/blase147/react-capstone-hub.git
```
