...
## Steps
- To clone the project select the desired directory in cmd and run: `git clone https://github.com/blase147/react-capstone.git`
...
```bash
git clone https://github.com/blase147/react-capstone.git
```
